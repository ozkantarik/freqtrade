...
- [x] **Option 2: Pure Trend Following:** Build a strategy that identifies and follows major trends without predicting specific price targets.
...
- [ ] **Concept 5: Trend-Continuation Classifier:** Identify a strong trend and then use an AI model to predict if the trend will continue.
