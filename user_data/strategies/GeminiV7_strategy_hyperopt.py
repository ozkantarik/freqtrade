...
class GeminiV7_strategy(IStrategy):
    ...
    # --- Optimizable parameters for the trend filter ---
    buy_adx_threshold = IntParameter(10, 50, default=39, space="buy")
    fast_ema_period = IntParameter(10, 60, default=35, space="buy")
    slow_ema_period = IntParameter(100, 300, default=237, space="buy")
